...
<body>
    ...
    <?php
        ...
        function single_delete_button() {
            ...
            //delete route sql
            $sql = "DELETE FROM Architekci WHERE Id=$route_id";
            //query
        ...
        class search {
            ...
            function get_primary_data() {
                ...
                $this->columns = ["Imie", "Nazwisko"];
                //set search variable with primary syntax
                $this->search_sql = "SELECT * FROM Architekci WHERE ";
            }
                ...
                while($row = $query->fetch_array(MYSQLI_ASSOC)) {
                    echo "
                        <tr>
                            ...
                            <td>{$row['Imie']}</td>
                            <td>{$row['Nazwisko']}</td>
                            <td><a href='index.php?strona=architekci/architekt&id={$row['Id']}'>Edycja</a>
                        </tr>
                    ";
                }
            }
            ...
            <div id="search-holder">
                <div id="search-header">
                    <div id="input-holder" class="search-holders">
                        <input type="text" name="search-input" id='search-input' placeholder="Wyszukaj architekta...">
                    </div>
                    ...
                    <tbody>
                        <form method="POST">
                            <?php
                                ...
                                $sql_all_users = "SELECT * FROM Architekci";
